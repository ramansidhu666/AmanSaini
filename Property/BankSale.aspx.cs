    ...
    public partial class BankSale : System.Web.UI.Page
    {
        ...
        public void SendMailToAdmin(string UserEmailId)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                mail.Subject = "Aman Saini : '" + txtFirstName.Text + " :  " + txtPhoneNo.Text;
                //string body = "";
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>E-mail:</p><span style='float:left;'amandeals@yahoo.ca</span><br/>");
